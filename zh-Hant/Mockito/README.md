...
簡潔的 API 設計讓學習和使用變得輕鬆。強大的功能支援方法呼叫驗證、返回值設定、異常拋出模擬、參數匹配等高級特性。優秀的可讀性使測試程式碼直觀易懂，驗證失敗時還能提供清晰的錯誤訊息。活躍的社群確保了框架的持續更新和文件的不断完善。
...
官方網站提供了完整的文件和範例程式碼。GitHub 倉庫包含了原始碼和版本發布資訊。線上文件提供了 API 參考和使用指南。
