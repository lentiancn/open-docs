...
- **Architecture**: Plugin-based architecture (Berry)
- **Features**: Native workspace support, PnP (Plug'n'Play), offline caching, parallel installs
- **Installation**: Recommended via Corepack
- **Status**: Actively developed

### Yarn v1 (Classic)
- **Architecture**: Traditional architecture
- **Features**: Simple and straightforward, widely compatible
- **Installation**: Via npm global install
- **Status**: Maintained

> Note: Unlike most other package managers, which typically defer to npm for non-install-related commands, Yarn reimplements all commands, so as to have full control over our developer experience and stability.