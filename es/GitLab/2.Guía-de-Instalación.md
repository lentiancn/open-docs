...
### Paquete Omnibus (Recomendado para Linux)
...
```bash
# Descargar imagen Docker GitLab
docker run --detach \
...
1. Acceda a GitLab en su URL externa
2. Inicie sesión con usuario: `root`
3. La contraseña se establece en la primera visita
...
- Configurar espacio swap apropiado
- Usar PostgreSQL tuning

---

## Recursos

- Docs Instalación Oficial: https://docs.gitlab.com/ee/install/
- Requisitos Hardware: https://docs.gitlab.com/ee/install/requirements.html
