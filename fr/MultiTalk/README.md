...
MultiTalk est un cadre de génération de video conversationnelle multi-personnes gele par l'audio developpe par l'équipe MeiGen-AI. Ce projet peut generer du contenu video de haute qualite contenant des interactions multi-personness basé sur des entrées audio multiflux, des images de référence et des invites de texte.

## Caracteristiques principales

- Generation de video conversationnelle multi-personnes gelee par l'audio
