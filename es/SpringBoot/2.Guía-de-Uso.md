...
Esta guía cubre la creación de aplicaciones Spring Boot, APIs REST, integración con bases de datos, pruebas y despliegue.
...
```xml
<!-- H2 (Predeterminado para Desarrollo) -->
<dependency>
...
### Empaquetar como WAR (para Tomcat Externo)
...
| `/actuator/beans` | Todos los beans |
| `/actuator/mappings` | Mapeos de URL |
...
- [Documentación Oficial de Spring Boot](https://docs.spring.io/spring-boot/docs/current/reference/)
